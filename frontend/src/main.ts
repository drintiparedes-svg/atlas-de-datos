...
import { renderInventario } from "./ui/inventory";
...
async function boot() {
  ...
  const app = new App();
  app.renderers = { nota: renderNota, inventario: renderInventario, secciones: renderSecciones, facetas: renderFacetas, relaciones: renderRelaciones, fuentes: renderFuentes, traza: renderTraza };
  app.afterRender = { relaciones: afterRelaciones, fuentes: afterFuentes };
