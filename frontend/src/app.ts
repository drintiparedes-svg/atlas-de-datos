...
export type Tab = "nota" | "proyectos" | "secciones" | "facetas" | "relaciones" | "patrones" | "fuentes" | "traza";
...
export class App {
  ...
  syncBack() {
    ...
    const tabName: Record<Tab, string> = { nota: "Inicio", proyectos: "Proyectos", secciones: "Secciones", facetas: "Facetas", relaciones: "Relaciones", patrones: "Patrones", fuentes: "Fuentes", traza: "Trazabilidad" };
